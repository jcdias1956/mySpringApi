...
public class FotoProdutoModelAssembler 
	...
	public FotoProdutoModel toModel(FotoProduto fotoProduto) {
		...
		fotoProdutoModel.add(algaLinks.linkToFotoProduto(fotoProduto.getRestauranteId(),
				fotoProduto.getProduto().getId()));
		
		fotoProdutoModel.add(algaLinks.linkToProduto(fotoProduto.getRestauranteId(),
