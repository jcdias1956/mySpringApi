...
public class CidadeModelAssembler 
	...
	public CidadeModel toModel(Cidade cidade) {
		...
		// usando RepresentationModelAssemblerSupport este self e criado automaticamente
		// e ai cria o cidadeModel pelocreateModelWithId
//		CidadeModel cidadeModel =  modelMapper.map(cidade, CidadeModel.class);
//		cidadeModel.add(WebMvcLinkBuilder
//				.linkTo(WebMvcLinkBuilder.methodOn(CidadeController.class)
