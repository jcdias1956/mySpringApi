...
/**
 * Usando SpringFox3.0 e Open API 3 nao precisa desta classe ...Adapter
 * @author jcdias
 *
 */
@Primary
@Component
public class TypeNameExtractAdapter extends TypeNameExtractor {

	private final TypeResolver typeResolver;
	private final PluginRegistry<TypeNameProviderPlugin, DocumentationType> typeNameProviders;
	private final EnumTypeDeterminer enumTypeDeterminer;

	public TypeNameExtractAdapter(TypeResolver typeResolver,
