...
//		System.out.println("id= " + storageProperties.getS3().getIdChaveAcesso());
//		System.out.println("chave= " + storageProperties.getS3().getChaveAcessoSecreta());
//		System.out.println("region= " + storageProperties.getS3().getRegiao());
//		System.out.println("bucket= " + storageProperties.getS3().getBucket());
