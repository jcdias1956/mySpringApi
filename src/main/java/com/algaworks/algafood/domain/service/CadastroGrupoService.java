...
import com.algaworks.algafood.domain.exception.GrupoNaoEcontradoException;
...
public class CadastroGrupoService {
	...
	public void excluir(Long grupoId) {
		...
		try {
			...
			throw new GrupoNaoEcontradoException (grupoId);
	...
	public Grupo buscarOuFalhar(Long grupoId) {
		return grupoRepository.findById(grupoId)
				.orElseThrow(() -> new GrupoNaoEcontradoException(grupoId));
	}
